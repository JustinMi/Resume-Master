...
\end{tabular*}
    ...
    \end{tabular*}
        ...
        \noindent
        \noindent \rule{0cm}{1pt}$\bullet$ Created a Facebook Messenger bot that pairs users up for anonymous social interactions. Over 100 users and growing.\\
...
\end{tabular*}
    {
    \noindent
    \textbf{Skilled} -- Python, Java, Ruby, Rails, HTML, CSS, Javascript, SQL, Scheme, LaTex, Git, CAD, Ethereum, Solidity, Django, AngularJS, jQuery, Node.js, Mandarin Chinese\\
